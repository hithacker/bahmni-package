...
mysql -h $OPENMRS_DB_SERVER -u$MYSQL_ROOT_USER -p$MYSQL_ROOT_PASSWORD -e "CREATE USER '$OPENMRS_DB_USERNAME'@'$OPENMRS_DB_SERVER' IDENTIFIED BY '*';
    GRANT ALL PRIVILEGES ON $OPENMRS_DB_NAME.* TO '$OPENMRS_DB_USERNAME'@'$OPENMRS_DB_SERVER' identified by '$OPENMRS_DB_PASSWORD'  WITH GRANT OPTION;"
